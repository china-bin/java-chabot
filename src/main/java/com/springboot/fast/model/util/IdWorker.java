...
public class IdWorker {
	...
	public static synchronized long getUserNo() {
		LocalDateTime time = LocalDateTime.now();
		DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
		String userNo =  dtf2.format(time);
...
class SystemClock {
	...
	public static void main(String[] args) {
		System.out.printf("id:" + IdWorker.getId());
		System.out.println("uuid:" + IdWorker.get32UUID());
		System.out.println("userno:" + IdWorker.getUserNo());
	}
