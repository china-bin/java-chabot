...
import com.springboot.fast.config.ToolPropConfig;
import com.springboot.fast.exception.ComplieException;
...
import com.springboot.fast.model.util.ClassClassLoader;
import com.springboot.fast.model.util.Constans;
...
@Service
public class JavaComplieServiceImpl implements IJavaComileService {
    private Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    ToolPropConfig toolPropConfig;
    ...
    public Class complie(String javaSource, String className) throws Exception {
        ...
        Iterable options = Arrays.asList("-d", Constans.comilePath);
...
//        }
    ...
    private ResultResponse excuteMainMethodWithClass(Class clazz, String[] args) throws Exception {
        ...
        //执行Main方法
        Method method = clazz.getMethod(toolPropConfig.getExcuteMainMethodName(), String[].class);
